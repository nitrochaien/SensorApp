...
public class Constant
{
    ...
    public static final String BIKE_FILE_NAME = "bike.csv"; //name of car activity file
    public static final String BIKE_FILE_NAME_ARFF = "bike.arff"; //name of car activity file
